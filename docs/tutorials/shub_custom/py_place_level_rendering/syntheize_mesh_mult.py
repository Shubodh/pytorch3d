...
def viz_image(RT_list, camera, dest_dir, mesh_dir, device):
    ...
    for i, RT in enumerate(RT_list):
        print("TODO3: Lack of clarity on w_t_c. Rewrite the function as inverse_tf or something. It goes to redner_ func and gets w_to_c'ed again")
        ...
        redner_py3d_img(img_size, param, dest_file, mesh_dir, device)
